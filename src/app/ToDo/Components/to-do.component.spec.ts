...
describe('ToDoComponent', () => {
  ...
  it('Get ToDo Effects - loads data from API', () => {
    let nextState: ToDoState = {
      ToDos: [{ title: 'First', completed: true }],
      ToDoError: null
    };
    store.setState({ todos: nextState });
    ...
    const payload = [{ title: 'second', completed: true }];
  ...
  it('To Do component show latest todos', () => {
    const firstWish = { title: 'First Wish', completed: true };
    const secondWish = { title: 'Second Wish', completed: false };
